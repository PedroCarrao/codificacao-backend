...
route.delete("/:id", (req, res) => {
    ...
    console.log("Atualização parcial via PATCH");
    const { id } = req.params;
    const data = req.body; // Pegamos o corpo da requisição sem desestruturar fixo

    // Chamamos o service passando o objeto data (que pode ter só o nome, ou mais campos)
